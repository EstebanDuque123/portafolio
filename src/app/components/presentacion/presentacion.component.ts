...
export class PresentacionComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private texts = [  'Analista de Datos',  'Python para Análisis de Datos',  'Dashboards en Power BI',  'Automatización con Python',  'Aplicaciones con LLMs', 'Programador Python'];
  private textIndex = 0;
  private charIndex = 0;
